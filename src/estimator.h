...
class Estimator
{
  public:
    ...
    double para_Pose_eR[WINDOW_SIZE+1][2];
    double para_Pose_eT[WINDOW_SIZE+1][1];
    double para_Pose_so3[WINDOW_SIZE+1][6];
    double World_Pose[SIZE_POSE];
    double para_Feature[NUM_OF_F][SIZE_FEATURE];
    double para_Ex_Pose[NUM_OF_CAM][SIZE_POSE];
    double para_Retrive_Pose[SIZE_POSE];
    double para_plane_pose[3];
